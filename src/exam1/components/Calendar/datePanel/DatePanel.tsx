...
<DateControls titleClick={switchMode} onNext={onNext} onPrev={onPrev} monthView={currentMonthView}/>
<DateTable monthView={currentMonthView} selected={selected} onSelect={selectDate}/>
        </div>
    )
}
